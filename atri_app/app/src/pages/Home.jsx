...
const FlexBrowseProps = useStore((state)=>state["Home"]["FlexBrowse"]);
const FlexBrowseIoProps = useIoStore((state)=>state["Home"]["FlexBrowse"]);
const FlexBrowseCb = useFlexBrowseCb()
...
const FlexAboutUsProps = useStore((state)=>state["Home"]["FlexAboutUs"]);
const FlexAboutUsIoProps = useIoStore((state)=>state["Home"]["FlexAboutUs"]);
const FlexAboutUsCb = useFlexAboutUsCb()
...
const FlexMenuProps = useStore((state)=>state["Home"]["FlexMenu"]);
const FlexMenuIoProps = useIoStore((state)=>state["Home"]["FlexMenu"]);
const FlexMenuCb = useFlexMenuCb()
...
const FlexSampleProps = useStore((state)=>state["Home"]["FlexSample"]);
const FlexSampleIoProps = useIoStore((state)=>state["Home"]["FlexSample"]);
const FlexSampleCb = useFlexSampleCb()
...
const FlexArticleProps = useStore((state)=>state["Home"]["FlexArticle"]);
const FlexArticleIoProps = useIoStore((state)=>state["Home"]["FlexArticle"]);
const FlexArticleCb = useFlexArticleCb()
...
const FlexLastProps = useStore((state)=>state["Home"]["FlexLast"]);
const FlexLastIoProps = useIoStore((state)=>state["Home"]["FlexLast"]);
const FlexLastCb = useFlexLastCb()
...
const FlexFinalProps = useStore((state)=>state["Home"]["FlexFinal"]);
const FlexFinalIoProps = useIoStore((state)=>state["Home"]["FlexFinal"]);
const FlexFinalCb = useFlexFinalCb()
...
const TextBoxWhatProps = useStore((state)=>state["Home"]["TextBoxWhat"]);
const TextBoxWhatIoProps = useIoStore((state)=>state["Home"]["TextBoxWhat"]);
const TextBoxWhatCb = useTextBoxWhatCb()
...
<Flex className="p-Home FlexBrowse bpt" {...FlexBrowseProps} {...FlexBrowseCb} {...FlexBrowseIoProps}>
...
<Flex className="p-Home FlexAboutUs bpt" {...FlexAboutUsProps} {...FlexAboutUsCb} {...FlexAboutUsIoProps}>
...
<Flex className="p-Home FlexMenu bpt" {...FlexMenuProps} {...FlexMenuCb} {...FlexMenuIoProps}>
...
<Flex className="p-Home FlexSample bpt" {...FlexSampleProps} {...FlexSampleCb} {...FlexSampleIoProps}>
...
<Flex className="p-Home FlexArticle bpt" {...FlexArticleProps} {...FlexArticleCb} {...FlexArticleIoProps}>
<Flex className="p-Home Flex130 bpt" {...Flex130Props} {...Flex130Cb} {...Flex130IoProps}>
<TextBox className="p-Home TextBox142 bpt" {...TextBox142Props} {...TextBox142Cb} {...TextBox142IoProps}/>
</Flex>
<TextBox className="p-Home TextBoxWhat bpt" {...TextBoxWhatProps} {...TextBoxWhatCb} {...TextBoxWhatIoProps}/>
...
<Flex className="p-Home FlexLast bpt" {...FlexLastProps} {...FlexLastCb} {...FlexLastIoProps}>
...
<Flex className="p-Home FlexFinal bpt" {...FlexFinalProps} {...FlexFinalCb} {...FlexFinalIoProps}>
